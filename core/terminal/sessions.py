...
from core.common.text_encoding import decode_utf8, open_utf8


def _home_base() -> Path:
    """Base dir the dashboard reads from. Override with LUCID_HOME to
    point at a fixture/demo tree (used for screenshots, demos, and tests)."""
    env = os.environ.get("LUCID_HOME")
